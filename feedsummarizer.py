...
default['smtp'] = os.environ.get("FEEDSUMMARIZER_SMTP_SERVER") or ""
default['port'] = os.environ.get("FEEDSUMMARIZER_SMTP_PORT") or 465
default['username'] = os.environ.get("FEEDSUMMARIZER_SMTP_USER") or ""
default['password'] = os.environ.get("FEEDSUMMARIZER_SMTP_PASSWORD") or ""
